...
Rails.application.configure do
  ...
  config.action_controller.default_url_options = {host: '167.172.35.71'}
  ...
  config.action_cable.allowed_request_origins = ["http://167.172.35.71"]
  ...
  # config.active_job.queue_name_prefix = "eventplus_production"
